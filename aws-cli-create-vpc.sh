...
SUBNET_PUBLIC_CIDR="10.200.1.0/24"
SUBNET_PUBLIC_AZ="us-east-1a"
SUBNET_PUBLIC_NAME="10.200.1.0 - vpc-08 publ"

SUBNET_PUBLIC_CIDR2="10.200.3.0/24"
SUBNET_PUBLIC_AZ2="us-east-1a"
SUBNET_PUBLIC_NAME2="10.200.3.0 vpc-08 publ"

SUBNET_PRIVATE_CIDR="10.200.2.0/24"
SUBNET_PRIVATE_AZ="us-east-1a"
SUBNET_PRIVATE_NAME="10.200.2.0 vpc-08 priv"
CHECK_FREQUENCY=5
...
SUBNET_PUBLIC_ID=$(aws ec2 create-subnet \
  ...
  --output text \
  --region $AWS_REGION)
echo "  Subnet ID '$SUBNET_PUBLIC_ID' CREATED in '$SUBNET_PUBLIC_AZ2'" \
  "Availability Zone."
